...
Spork.prefork do
  ...
  # Requires supporting ruby files with custom matchers and macros, rtc,
...
(ActiveRecord::Migration)
  ...
  RSpec.configure do |config|
    ...
    # If you're not using ActiveRecord, or you7d prefer not to run each of
    # your examples within a transaction, remove the following line or
    # assign false instead of true.
    config.use_transactional_fixtures = true

    # If ture, the base class of anonymous controllers will be inferred
    # automatically. This will be the default behavior in future versions of
    # rspec-rails.
    config.infer_base_class_for_anonymous_controllers = false

    # Run specs in random order to surface order dependecies.If you
