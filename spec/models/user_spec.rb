...
describe User do
  ...
  describe "when email format is invalid" do
    it "should be invalid" do
      address = %w[user@foo,com user_at_foo.org example.user@foo.foo@bar_baz.com 
foo@bar+baz.com goo@bar..com]
  ...
  describe "with a password that7s too short" do
    before { @user.password = @user.password_confirmation = "a" * 5 }
    it { should be_invalid }
  end

  describe "return value od authenticate method" do
    before { @user.save }
